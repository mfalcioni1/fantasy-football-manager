...
pos_corrections = {
    "Def": "DST", "D": "DST", "DEF": "DST", "D/ST": "DST", "PK": "K",
...
# Team corrections
team_corrections = {
    "KCC": "KC", "SFO": "SF", "TBB": "TB", "NEP": "NE", "RAM": "LAR",
...
# MFL Team abbreviations
mflTeam_abb = [abb if abb != "JAX" else "JAC" for abb in nflTeam_abb]
mflTeam_abb = [abb if abb != "LA" else "LAR" for abb in mflTeam_abb]

# NFL Team IDs
nflTeam_id = [
    "100026", "100001", "100002", "100003", "100004", "100005", "100006", "100007",
...
nflTeam_name = [
    ...
    "Rams", "49ers", "Chargers", "Buccaneers", "Titans", "Commanders", "Seahawks", "Raiders"
]

# Creating player_table object
player_table = None
...
# Fantasy Sharks Columns
fantasysharks_columns = {
    "Player ID": "id",
    "Player Name": "player",
    "Position": "pos",
    "Team": "team",
...
# Numberfire IDP Columns
numberfire_idp_columns = {
    "id": "id",
    "numfire_id": "src_id",
    "Player": "player",
    "position": "pos",
...
# NFL FastR Calc Player Stats Columns
nflfastr_calc_cols = {
    ...
    "receiving_epa": None,
    "receiving_2pt_conversions": None,
    "racr": None,
    "target_share": None,
